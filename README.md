...
|-----------|----------------|----------|
| Staging: Gemara pack, digest, SLSA + SPDX | [`reusable_publish_oras.yml` (Gemara-only) @8ffcea9…](https://github.com/sonupreetam/org-infra-tests/blob/8ffcea997fc3026f62fc54c645974c51b42b7aa0/.github/workflows/reusable_publish_oras.yml) in [org-infra-tests](https://github.com/sonupreetam/org-infra-tests) (not yet on [public org-infra](https://github.com/complytime/org-infra) `main` at this pin) | **Yes** (oci-artifact composite in that workflow) |
| Staging: keyless cosign + verify | [`reusable_sign_and_verify.yml@8ffcea9…`](https://github.com/sonupreetam/org-infra-tests/blob/8ffcea997fc3026f62fc54c645974c51b42b7aa0/.github/workflows/reusable_sign_and_verify.yml) | — |
| Cross-registry promote | [`resuable_publish_quay.yml@8ffcea9…`](https://github.com/sonupreetam/org-infra-tests/blob/8ffcea997fc3026f62fc54c645974c51b42b7aa0/.github/workflows/resuable_publish_quay.yml) | — |
...
| Piece | Interim value |
|-------|----------------|
| Staging (Gemara + attest) | [`reusable_publish_oras`](https://github.com/sonupreetam/org-infra-tests/blob/8ffcea997fc3026f62fc54c645974c51b42b7aa0/.github/workflows/reusable_publish_oras.yml) (embeds `sonupreetam/gemara-publish-oci@7203d6…`) |
| org-infra-tests (staging + sign + Quay `uses:`) | `sonupreetam/org-infra-tests@8ffcea997fc3026f62fc54c645974c51b42b7aa0` |
